...
public class CavePrevious : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider col)
    {
        if (col.tag == "Player")
        {
            ...
            seed = gameManager.currentPath[gameManager.pathProgress].x;
            difficulty = gameManager.currentPath[gameManager.pathProgress].y;
            //x = seed
            //y = difficulty
            //z = type
